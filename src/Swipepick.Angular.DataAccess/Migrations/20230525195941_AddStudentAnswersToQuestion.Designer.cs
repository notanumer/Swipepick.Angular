...
namespace Swipepick.Angular.DataAccess.Migrations
{
    ...
    [Migration("20230525195941_AddStudentAnswersToQuestion")]
    partial class AddStudentAnswersToQuestion
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Swipepick.Angular.Domain.StudentAnswer", b =>
                {
                    b.HasOne("Swipepick.Angular.Domain.Question", "Question")
                        ...
                        .HasForeignKey("Swipepick.Angular.Domain.StudentAnswer", "QuestionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
